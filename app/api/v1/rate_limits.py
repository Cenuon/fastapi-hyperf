...
from app.core.auth.http_exceptions import DuplicateValueException, HTTPException, NotFoundException
from app.core.dependencies import AsyncSessionDep, CurrentSuperUserDep
from app.utils.exceptions import ResourceExistsError, ResourceNotFoundError
...
from app.services.rate_limit import RateLimitServiceDep
from app.models.rate_limit import (
    RateLimitRead,
    RateLimitUpdate,
)

router = create_unified_router(tags=["Rate Limits"])


@router.get(
    "/",
    response_model=PaginatedData[RateLimitRead],
    description="""
...
async def get_rate_limits(
    ...
    try:
        ...
        return unified_paginated_response(crud_data=rate_limits_data, page=page, items_per_page=items_per_page)
