...
from app.core.dependencies import AsyncSessionDep, CurrentUserDep
...
from app.services.api_key import APIKeyServiceDep
...
router = create_unified_router(tags=["API Keys"])
...
@router.get(
    "/",
    response_model=PaginatedData[APIKeyRead],
    description="""
...
async def get_user_api_keys(
    ...
    try:
        ...
        return unified_paginated_response(
            crud_data=result,
            page=page,
...
@router.get(
    "/{key_id}/usage",
    response_model=PaginatedData[KeyUsageRead],
    description="""
