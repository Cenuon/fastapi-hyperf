...
from app.models.user import crud_users
from app.models.user import OAuthProvider
from app.core.conf.settings import get_settings
...
from app.core.auth.http_exceptions import UnauthorizedException
from app.core.auth.oauth.dependencies import get_oauth_state
from app.core.auth.oauth.schemas import OAuthState, OAuthToken
from app.core.auth.oauth.services import oauth_account_service
from app.core.auth.session.dependencies import authenticate_user

settings = get_settings()
logger = get_logger()

router = create_unified_router(tags=["Authentication"])
