...
from app.core.auth.http_exceptions import HTTPException
from app.core.dependencies import AsyncSessionDep, CurrentSuperUserDep, CurrentUserDep
from app.models.base import PaginatedData
from app.models.user import UserCreate, UserRead, UserTierUpdate, UserUpdate
...
@router.get(
    "/",
    response_model=PaginatedData[UserRead],
    description="""
...
async def get_users(
    ...
    return unified_paginated_response(crud_data=users_data, page=page, items_per_page=items_per_page)
