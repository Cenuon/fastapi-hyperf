...
from app.core.conf import CacheBackend, get_settings
from app.core.rate_limit.provider import rate_limiter_provider
...
async def close_rate_limiter() -> None:
    ...
    It gracefully handles cases where initialization never completed.
    """
    settings = get_settings()
    ...
    backend_name = settings.RATE_LIMITER_BACKEND
