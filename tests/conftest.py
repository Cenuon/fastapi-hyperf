...
from app.core.auth.session.backends.memory import MemorySessionStorage
from app.core.auth.session.dependencies import get_current_superuser, get_current_user
from app.core.auth.session.schemas import CSRFToken, SessionData
from app.core.auth.utils import get_password_hash
from app.core.config.settings import Settings, get_settings
from app.core.database.session import Base, async_session
from app.api.main import app
from app.models.tier.models import Tier
...
def mock_session_backend(monkeypatch):
    ...
    monkeypatch.setattr("app.core.auth.session.storage.get_session_storage", override_session_dependency)
    monkeypatch.setattr("app.core.auth.session.manager.get_session_storage", override_session_dependency)
